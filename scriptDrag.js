...
draggerArea.addEventListener('dragover', (e) => {
    e.preventDefault(); dragText.textContent = "Relancer la page pour télécharger de nouveau 1 image"
});
draggerArea.addEventListener('dragleave', () => {
    dragText.textContent = "Drag and Drop File", dragText.textContent = "Relancer la page pour télécharger de nouveau 1 image"
  });
